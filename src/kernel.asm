...
; Entrypoint passes to Kernel_Init to set the system up for use
	...
	NEW_BLOB_SPAWN $11, $15, %00000000, BLOB_REEL_RIGHT
	NEW_BLOB_SPAWN $33, $33, %00000001, BLOB_REEL_UP
	NEW_BLOB_SPAWN $55, $55, %00000011, BLOB_REEL_LEFT
	NEW_BLOB_SPAWN $77, $77, %00000010, BLOB_REEL_DOWN
	NEW_BLOB_SPAWN $11, $88, %00000000, BLOB_REEL_DOWN
	NEW_BLOB_SPAWN $33, $66, %00000001, BLOB_REEL_DOWN
	NEW_BLOB_SPAWN $55, $40, %00000011, BLOB_REEL_DOWN
	NEW_BLOB_SPAWN $77, $22, %00000010, BLOB_REEL_DOWN
