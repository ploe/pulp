...
; bc <~> This
	...
	MEMBER_ADDRESS (BLOB_II_SPRITE + SPRITE_INTERVAL)
	dec [hl]
	jr z, .nextFrame
...
.nextFrame
	...
	MEMBER_PEEK_WORD (BLOB_II_SPRITE + SPRITE_FRAME)
	ld hl, FRAME_SIZE
	add hl, de
	ld b, h
	ld c, l
...
Blob_II_Spawn_All::
	...
	BLOB_SPAWN $39, $42, %00000011, BLOB_II_REEL_UP
	BLOB_SPAWN $11, $22, %00000001, BLOB_II_REEL_LEFT
	BLOB_SPAWN $36, $88, %00000010, BLOB_II_REEL_DOWN
	BLOB_SPAWN $88, $36, %00000000, BLOB_II_REEL_DOWN
...
.copySprite
	...
	MEMBER_PEEK_WORD (BLOB_II_SPRITE + SPRITE_TILE_DST)
	push de

	; Get the Tile Src
	MEMBER_PEEK_WORD (BLOB_II_SPRITE + SPRITE_TILE_SRC)
